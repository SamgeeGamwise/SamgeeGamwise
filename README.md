...
**Software Engineer** with 4+ years of professional experience building and maintaining full-stack web applications at enterprise scale. I bridge the gap between technical implementation and real business needs — thanks in part to a background in payroll operations that keeps me grounded in how software actually gets used.

Currently working at **HireVue** maintaining an assessment platform used by millions. Freelancing on the side. Building things in Rust for fun.

📄 [linkedin.com/in/samkrohn](https://www.linkedin.com/in/samkrohn/) &nbsp;|&nbsp; 🌐 [samgee.gamwise.me](https://samgee.gamwise.me) &nbsp;|&nbsp; 📧 sk.n8594@gmail.com

---

## 💼 Experience

**Software Engineer — HireVue** *(Apr 2022 – Present)*
- Maintains and enhances a client-facing assessment platform using AngularJS, ASP.NET, and Microsoft SQL Server
- Built internal automation tools with Next.js that eliminated recurring manual data entry errors
- Developed bulk file scripts to streamline multi-environment client deployments
...
- Stack: Angular, Vue, Laravel, PostgreSQL, Docker
